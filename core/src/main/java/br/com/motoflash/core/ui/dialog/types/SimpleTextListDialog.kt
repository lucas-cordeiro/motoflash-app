...
class SimpleTextListDialog(val title: String, val label: String, val callback: DialogListener, val list: List<SimpleTextAdapter.SimpleText>, val dark: Boolean) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val adapter = SimpleTextAdapter(object : SimpleTextAdapter.ClickCallback{
            override fun onClick(position: Int, simpleText: SimpleTextAdapter.SimpleText) {
                callback.onTextSelect(simpleText.id, this@SimpleTextListDialog)
            }
